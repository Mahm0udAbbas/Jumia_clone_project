  ...
  return (
    <Card className='flex flex-col items-center mt-10' shadow={false}>
      <div className='flex flex-col items-center w-[30rem]'>
        <Image width={120} height={120} className='object-cover object-center mb-3' src={topLogo} alt='logo-image' />
      ...
      <form className="mb-20" onSubmit={handleSubmit(userLogin)}>
        <div className='w-[28rem] mt-20' >
          <Input size="lg" value={email} {...register("email")} disabled color='orange' label="Enter your email" />
        </div>
        <div className='w-[28rem] my-10'>
          <Input size="lg" onClick={()=>{setErrors({...errors, password:""})}} color={(errors.password) ? "red" : "orange"} label="Password" {...register("password", { required: true, minLength:{value:8,message:"Must be 8 characters." }})} />
      ...
      <div className='w-[28rem]'>
        ...
        <div className='flex flex-col  items-center mt-5'>
          <Image width="70" height="70" className='object-cover object-center' src={bottomLogo} alt='another-logo' />
        </div>
      </div>
    </Card>
  )
