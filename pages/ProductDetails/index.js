...
const ProductDetails = () => {
  ...
  return (<>
    ...
    <div className='container-lg'>
      <div className='lg:hidden block' style={{ padding: '20px' }}>
        <div style={{ padding: 10 }}>
          <p>
            <a href="/" className='me-2 text-reset text-decoration-none' style={{ fontSize: 13 }}>Home {'> '} </a>
            <a href="/category" className='me-2 text-reset text-decoration-none' style={{ fontSize: 13 }}>Phones & Tablet {'>'}</a>
            <a href="/category" className='me-2 text-reset text-decoration-none' style={{ fontSize: 13 }}>Mobile Phones {'>'}</a>
            <a href='/ProductDetails' className='me-2 text-decoration-none baby' style={{ fontSize: 13 }}>XIAOMI Redmi Note 13 6.67" 6GB RAM/128GB ROM Android 12 - Black</a>
          </p>
        </div>
        <section className={`${Styles.detailsSection} bg-white mt-2 col-span-10`} id='detail' style={{ borderRadius: '5px', padding: 10 }}>
          <section className={`${Styles.detailsSection} bg-white mt-2 col-span-9`} id='detail' style={{ borderRadius: '5px', padding: 10 }}>
            <section className={`${Styles.detailsSection} bg-white mt-2 col-span-9`} id='detail' style={{ borderRadius: '5px', padding: 10 }}>
              <div className='grid grid-cols-12 gap-4 mt-3'>
                <div className='col-span-4'>
                  ...
                  <p className='mx-2 me-2 text-gray-700 hover:text-gray-900 text-decoration-none' style={{ padding: 10 }}>SHARE THIS PRODUCT</p>
            ...
            <section className='col-span-3' >
              <div className={`bg-white px-2 mt-2 pt-2 ${Styles.detailsection2}`} style={{ borderRadius: '5px', color: 'black' }}>
                <div className={Styles.dtsub1}>
                  <p style={{ fontSize: '.875rem', fontWeight: 500 }}>DELIVERY RETURNS</p>
                </div>
                <div className='w-full border-b border-gray-200 my-2'></div>
                ...
                <div>
                  <div className='flex' style={{ padding: 10 }}>
                    ...
                    <div>
                      ...
                      <p className={Styles.subb4}>Ready for delivery when you order within next 3hrs 24mins</p>
                    </div>
                  </div>
                </div>
                ...
                <div >
                  <div className='flex' >
                    ...
                    <div>
                      ...
                      <p className={Styles.subb4}>Free return legal return period from 14 to 30 days, and if they meet the terms & conditions, with the need to report any apparent defect within 48 hours. For more details about return policy.Details</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className='w-full md:w-11/12 lg:w-11/12 xl:w-11/12 mx-auto'>
        <div className='hidden lg:block'>
          <div className={` pt-4${Styles.navtext}`} style={{ padding: 10 }}>
            <p>
              <a href="/" className='me-2  text-decoration-none' style={{ fontSize: 13 }}>Home {'> '} </a>
              <a href="/category" className='me-2  text-decoration-none' style={{ fontSize: 13 }}>Phones & Tablet {'>'}</a>
              <a href="/category" className='me-2  text-decoration-none' style={{ fontSize: 13 }}>Mobile Phones {'>'}</a>
              <a href='/ProducDetails' className='me-2 text-decoration-none' style={{ fontSize: 13 }}>XIAOMI Redmi Note 13 6.67" 6GB RAM/128GB ROM Android 12 - Black</a>
            </p>
          </div>
          <div>
              ...
              <section className={`${Styles.detailsSection} bg-white mt-2 col-span-9`} id='detail' style={{ borderRadius: '5px' }}>
                <div className='grid grid-cols-12 gap-4 mt-3'>
                  <div className='col-span-4'>
                    ...
                    <p className='mx-2me-2 text-gray-700 hover:text-gray-900 text-decoration-none' style={{ paddingLeft: 50, fontSize: 13, paddingTop: 5 }}>SHARE THIS PRODUCT</p>
                  ...
                  <div className='col-span-8' style={{ padding: 10 }}>
                    ...
                    <div className='flex items-center'>
                      ...
                      <div className={`${Styles.random} mt-1 ms-1 text-gray-700 hover:text-gray-900`} style={{ fontSize: '.875rem', fontWeight: 500 }}>({Math.floor(Math.random() * 300)} verified ratings)</div>
                    </div>
                    <div className='w-full border-b border-gray-200 my-2 '></div>
                    <p className='text-gray-700 hover:text-gray-900'>VARIATION AVAILABLE</p>
                    <div className={`${Styles.variation} py-1`}>
          ...
          <div className='grid grid-cols-12 gap-4 px-2'>
            <section className={`${Styles.detailsSection} bg-white mt-2 col-span-9`} id='detail' style={{ borderRadius: '5px', padding: '20px' }}>
              <div className=' bg-white'>
                <p className=' text-gray-700 hover:text-gray-900' style={{ fontSize: '1.25rem', fontWeight: '500' }}>Product details</p>
          ...
          <div className='grid grid-cols-12 gap-4 px-2'>
            <section className={`${Styles.detailsSection} bg-white mt-2 col-span-9`} id='detail' style={{ borderRadius: '5px', padding: '20px' }}>
              <div className='bg-white'>
                <p className='text-gray-700 hover:text-gray-900' style={{ fontSize: '1.25rem', fontWeight: '500' }}>Specifications</p>
                <div className='my-4 border-b border-gray-100'></div>
                <div className='flex gap-10 pt-6'>
                  <table className='border w-1/2' style={{ padding: '20px', borderRadius: '10px' }}>
                    <thead>
                      <tr>
                        <th className='text-gray-700 hover:text-gray-900' style={{ fontSize: '.875rem', fontWeight: '500', padding: '15px' }}>SPECIFICATIONS</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td style={{ padding: '5px' }}>
                          <ul className='list-disc list-inside'>
                            <li className="text-base text-gray-700" style={{ fontSize: '0.85rem', fontWeight: '500', padding: '5px' }}>SKU: SA024MP1IC742NAFAMZ</li>
                            <li className="text-base text-gray-700" style={{ fontSize: '0.85rem', fontWeight: '500', padding: '5px' }}>Model: SM-A145F</li>
                            <li className="text-base text-gray-700" style={{ fontSize: '0.85rem', fontWeight: '500', padding: '5px' }}>Size (L x W x H cm): 167.7 x 78 x 9.1 mm</li>
                            <li className="text-base text-gray-700" style={{ fontSize: '0.85rem', fontWeight: '500', padding: '5px' }}>Color: Black</li>
                          </ul>
                        </td>
                      </tr>
                    </tbody>
                  </table>
                  <table className='border w-1/2' style={{ padding: '20px', borderRadius: '5px' }}>
                    <thead>
                      <tr>
                        <th className='text-gray-700 hover:text-gray-900' style={{ fontSize: '.875rem', fontWeight: '500', padding: '15px' }}>KEY FEATURES</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
          ...
          <div className='grid grid-cols-12 gap-4 px-2'>
            <section className={`${Styles.detailsSection} bg-white mt-2 col-span-9`} id='detail' style={{ borderRadius: '5px', padding: '20px' }}>
              <div className=' bg-white'>
                <p className='text-gray-700 hover:text-gray-900' style={{ fontSize: '1.25rem', fontWeight: '500' }}>Customers who viewed this also viewed</p>
          ...
          <div className='grid grid-cols-12 gap-4 px-2'>
            <section className={`${Styles.detailsSection} bg-white mt-2 col-span-9`} id='detail' style={{ borderRadius: '5px', padding: 20 }}>
              <div className=' bg-white'>
                <p className='text-gray-700 hover:text-gray-900' style={{ fontSize: '1.25rem', fontWeight: '500' }}>You may also like</p>
                <ProductSection data={data5} display='hidden' flash='hidden' time='hidden' />
              </div>
            </section>
          </div>
        ...
        <div className='grid grid-cols-10 gap-4 px-2'>
          <section className={`${Styles.detailsSection} bg-white mt-2 col-span-10`} id='detail' style={{ borderRadius: '5px', padding: 20 }}>
            <div className='bg-white'>
              <p className='text-gray-700 hover:text-gray-900' style={{ fontSize: '1.25rem', fontWeight: '500' }}>More items from this seller</p>
              <ProductSection data={data5} display='hidden' flash='hidden' time='hidden' />
            </div>
          </section>
        </div>
        <div className='grid grid-cols-10 gap-4 px-2' style={{ paddingBottom: 20 }}>
          <section className={`${Styles.detailsSection} bg-white mt-2 col-span-10`} id='detail' style={{ borderRadius: '5px', padding: 20 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
              <h3 className='text-gray-700 hover:text-gray-900' style={{ fontSize: '1.25rem', fontWeight: '500' }}>Recently Viewed</h3>
